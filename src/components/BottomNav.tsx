...
const BottomNav = () => {
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 z-50 safe-area-bottom">
      ...
      <div className="bg-card/80 backdrop-blur-2xl shadow-[0_-4px_24px_rgba(0,0,0,0.08)]" style={{ borderTopLeftRadius: 15, borderTopRightRadius: 15, borderTop: "2px solid hsl(var(--border) / 0.5)" }}>
